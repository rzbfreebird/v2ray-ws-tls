...
install_v2ray(){
    ...
    cd /etc/v2ray/
    rm -f config.json
    wget https://raw.githubusercontent.com/rzbfreebird/v2ray-ws-tls/master/config.json
    ...
    cd /etc/nginx/html
    rm -f /etc/nginx/html/*
    wget https://github.com/rzbfreebird/v2ray-ws-tls/raw/master/web.zip
    unzip web.zip
...
remove_v2ray(){
    ...
    green "nginx、v2ray已删除"https://install.direct/go.sh
